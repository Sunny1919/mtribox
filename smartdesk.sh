...
ALPINE_VERSION="3.19"
ALPINE_FULL_VERSION="3.19.1"
APK_TOOLS_VERSION="2.14.0-r5" # Make sure to update this too when updating Alpine Linux.
...
if [ ! -e $ROOTFS_DIR/.installed ]; then
    ...
    # Added Node.js, Python 3.12, and tmate from edge repositories.
    /tmp/sbin/apk.static -X "https://dl-cdn.alpinelinux.org/alpine/edge/main/" \
        -X "https://dl-cdn.alpinelinux.org/alpine/edge/community/" \
        -U --allow-untrusted --root $ROOTFS_DIR add \
        alpine-base apk-tools nodejs python3 py3-pip tmate
...
╚══════╝╚═╝     ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝   ╚═╝   ╚═════╝ ╚══════╝╚══════╝╚═╝  ╚═╝
 ...
 Here are some useful commands to get you started:
    ...
    tmate : start a tmate session for instant terminal sharing
